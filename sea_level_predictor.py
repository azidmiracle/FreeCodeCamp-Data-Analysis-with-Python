...
def draw_plot():
    ...
    # Create scatter plot
    # Create scatter plot
    #x_yrs_extended=np.arange(1850,2050,25)
    x_yrs_extended=np.arange(x.min(),2050)
    ...
    x_yrs_extended_2=np.arange(x_2000.min(),2050)
    slope_2,intercept_2,r_value_2,p_value_2,std_err_2=linregress(x_2000,y_2000)
    line_2 = [slope_2*xi + intercept_2 for xi in x_yrs_extended_2]
    plt.plot(x_yrs_extended_2,line_2,'r',label='fitted line 2')
